...
We use something called states and in this blog I will show a simple example by using local data so you can replicate this easily.

I was trying to find a definition of States in React JS and this one and this version stood out to me. [React documentation](https://react.dev/learn/state-a-components-memory)
